...
// фильтрация по мин прочности
lowDur.addEventListener('blur', ()=>{
  cardsWrapper.innerHTML = null;
  ships.filter((card)=>{
    if(card.shipHull > lowDur.value){
      return   cardsWrapper.insertAdjacentHTML('beforeend', `
      <div class="main__card">
        <a href="#close" title="Закрыть" class="close">X</a>
      <div class="main__card-img">
...
//фильтрация по макс прочности
maxDur.addEventListener('blur', ()=>{
  cardsWrapper.innerHTML = null;
  ships.filter((card)=>{
    if(card.shipHull < maxDur.value){
      return   cardsWrapper.insertAdjacentHTML('beforeend', `
      <div class="main__card">
        <a href="#close" title="Закрыть" class="close">X</a>
      <div class="main__card-img">
